...
export const VirtualDetailList: VirtualSportsDetailModel[] = [
  ...
  export const VirtualDetailList1: VirtualSportsDetailModel[] = [
    { id: 11, name: '1-0', value: '55.0' },
    { id: 12, name: '1-2', value: '36.00'},
    { id: 13, name: '1-5', value: '41.00' },
    { id: 14, name: '1-6', value: '66.00'} 
  ];

export const VirtualGameSingleItem : VirtualSingleGame[]=[
    {id:12,  name:'CORRECT SCORE', gamedetailsublist: VirtualDetailList},
    {id:12,  name:'GAME RESULT', gamedetailsublist: VirtualDetailList1},
